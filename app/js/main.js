$(function(){
    ...
    $('.single-page__tabs .tab').on('click', function(event) {
      var id = $(this).attr('data-id');
        $('.single-page__tabs').find('.tab-item').removeClass('active-tab').hide();
        $('.single-page__tabs .tabs').find('.tab').removeClass('active');
